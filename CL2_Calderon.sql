...
CREATE TABLE Area (
  ...
  CREATE TABLE Personal (
    ...
    codigo INT,
    FOREIGN KEY (codigo) REFERENCES Area(codigo)
);
   
INSERT INTO Area (codigo, nombre_area, jefe_area) VALUES
    (1, 'CONTABILIDAD', 'Pedro Pascal'),
    (2, 'VENTAS', 'Ivan Rakitich'),
    (3, 'MARKETING', 'Bernardo Cuesta');

INSERT INTO Personal (id, nombre, codigo_trabajador, sueldo, codigo) VALUES
